...
ct_compare_test() ->
    true  = bksw_sec:ct_compare([],    [],    true ),
    false = bksw_sec:ct_compare([],    [],    false),

    false = bksw_sec:ct_compare([],    [x],   true ),
    false = bksw_sec:ct_compare([],    [x],   false),
    false = bksw_sec:ct_compare([x],   [],    true ),
    false = bksw_sec:ct_compare([x],   [],    false),

    true  = bksw_sec:ct_compare([x],   [x],   true ),
    false = bksw_sec:ct_compare([x],   [x],   false),

    false = bksw_sec:ct_compare([x],   [y],   true ),
    false = bksw_sec:ct_compare([x],   [y],   false),

    true  = bksw_sec:ct_compare([x,x], [x,x], true ),
    false = bksw_sec:ct_compare([x,x], [x,x], false),
    false = bksw_sec:ct_compare([x,x], [x,y], true ),
    false = bksw_sec:ct_compare([x,x], [x,y], false),
    false = bksw_sec:ct_compare([x,y], [x,x], true ),
    false = bksw_sec:ct_compare([x,y], [x,x], false),
    true  = bksw_sec:ct_compare([x,y], [x,y], true ),
    false = bksw_sec:ct_compare([x,y], [x,y], false),
    false = bksw_sec:ct_compare([x,y], [z,a], true ),
    false = bksw_sec:ct_compare([x,y], [z,a], false),

    % same length strings
    true   = bksw_sec:ct_compare("this is a test", "this is a test", true  ),
    false  = bksw_sec:ct_compare("this is a test", "this is a test", false ),

    % same length garbage strings
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu",  "garbage blah blah abc123jcyhfoiahfx", true ),
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu",  "garbage blah blah abc123jcyhfoiahfx", false),
    % different length garbage strings
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu",  "garbage blah blah abc123jcyhfoiahfx1", true),
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu",  "garbage blah blah abc123jcyhfoiahfx1", false),
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu1", "garbage blah blah abc123jcyhfoiahfx",  true ),
    false  = bksw_sec:ct_compare("garbage blah blah sihiufiusadfgfihu1", "garbage blah blah abc123jcyhfoiahfx",  false),
    false  = bksw_sec:ct_compare("garbage", "garbage blah blah abc123jcyhfoiahfx", true),
    false  = bksw_sec:ct_compare("garbage", "garbage blah blah abc123jcyhfoiahfx", false),
    false  = bksw_sec:ct_compare("garbage blah blah abc123jcyhfoiahfx", "garbage", true),
    false  = bksw_sec:ct_compare("garbage blah blah abc123jcyhfoiahfx", "garbage", false).
